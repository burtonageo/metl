...
fn main() {
    ...
    println!("Supports 24 bit stencil and 8 bit depth:\t{}", device.is_depth24_stencil8_pixel_format_supported());
    {
        let max_tpg = device.max_threads_per_group();
        println!("Maximum threads per group:\t\t\t({}, {}, {})", max_tpg.width, max_tpg.height, max_tpg.depth);
    }
